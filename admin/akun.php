        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><span class="lnr lnr-arrow-right"></span> <a href="akun.php"> Account</a></p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="../action/delete3.php?id_akun=<?php echo $data['id_akun']; ?>" class="close">
