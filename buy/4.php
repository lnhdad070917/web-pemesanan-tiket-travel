		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 insurence-left">
					<img class="img-fluid img-one" src="../img/insurence/bali.png" alt="">
				</div>
				<div class="col-lg-6 insurence-right">
					<h6 class="text-uppercase">Kota Bali</h6>
					<h1>Rincian Tiket Trip To Bali</h1>
					<div class="list-wrap">
						<ul>
							...
							<li>Extra: Uluwatu 1 hari 1 malam</li>
