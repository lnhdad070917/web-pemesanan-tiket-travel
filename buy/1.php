		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 insurence-left">
					<img class="img-fluid img-one" src="../img/insurence/jogja.png" alt="">
				</div>
				<div class="col-lg-6 insurence-right">
					<h6 class="text-uppercase">Daerah Istimewa Yogyakarta</h6>
					<h1>Rincian Tiket Trip To Jogja</h1>
					<div class="list-wrap">
						<ul>
							<li>Durasi: 3 hari and 2 malam </li>
							<li>Promo: Free Bakpia</li>
							<li>Fasilitas: Makan, Free Snacks, Hotel berbintang, tiket platinum yang bisa digunakan di 5 objek wisata</li>
							<li>Extra: Pantai Parangtritis</li>
							<li>Harga: Rp2,5jt/orang</li>
						</ul>
