		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 insurence-left">
					<img class="img-fluid img-one" src="../img/insurence/bromo.png" alt="">
				</div>
				<div class="col-lg-6 insurence-right">
					<h6 class="text-uppercase">Gunung Bromo</h6>
					<h1>Rincian Tiket Trip To Bromo</h1>
					<div class="list-wrap">
						<ul>
							<li>Durasi: 5 hari and 6 malam </li>
							<li>Promo: Free Kaos</li>
							<li>Fasilitas: Makan, Free Snacks, Hotel berbintang, tiket platinum yang bisa digunakan di 5 objek wisata</li>
							<li>Extra: Trip Jatim Park</li>
							<li>Harga: Rp4jt/orang</li>
						</ul>
