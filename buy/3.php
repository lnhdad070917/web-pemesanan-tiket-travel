		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 insurence-left">
					<img class="img-fluid img-one" src="../img/insurence/solo.png" alt="">
				</div>
				<div class="col-lg-6 insurence-right">
					<h6 class="text-uppercase">Kota Surakarta</h6>
					<h1>Rincian Tiket Trip To Solo</h1>
					<div class="list-wrap">
						<ul>
							<li>Durasi: 3 hari and 2 malam </li>
							<li>Promo: Free Batik</li>
							<li>Fasilitas: Makan, Free Snacks, Hotel berbintang, tiket platinum yang bisa digunakan di 5 objek wisata</li>
							<li>Extra: Stasiun Solo Balapan</li>
							<li>Harga: Rp1,8jt/orang</li>
						</ul>
