		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.php">Home </a> <span class="lnr lnr-arrow-right"></span> <a href="insurance.html"> autor</a></p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 insurence-left">
					<img class="img-fluid img-one" src="../img/didik1.JPG" alt="">
				</div>
				<div class="col-lg-6 insurence-right">
					<h6 class="text-uppercase">2003040156</h6>
					<h1>Didi Adi Darmawan</h1>
					<p>
